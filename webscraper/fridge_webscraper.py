# Webscraping for refrigerator parts
import json
...
fridge_parts_url = base_url + "/Refrigerator-Parts.htm"
page = urllib.request.urlopen(fridge_parts_url)
...
for link in links:
    ...
    for part in site_parts:
        ...
        fridge_parts.append(fridge_part)

# Export as json file
with open('output.json', 'w') as out_file:
    fridge_parts_dicts = [part.__dict__ for part in fridge_parts]
    json.dump(fridge_parts_dicts, out_file, indent=2)

# Export as csv file
with open('fridge_parts.csv', mode='w', newline='') as file:
